...
namespace Consignment_Control.Library.Services.Security
{
    public partial class EncryptionService : IEncryptionService
    {
        ...
        /// <summary>
        /// Encrypt Text into memory / bytes
        /// </summary>
        /// <param name="data">Text will been encrypt</param>
        /// <param name="key">Key of the memory</param>
        /// <param name="iv">value of the memory</param>
        /// <returns></returns>
        ...
        public virtual string EncryptText(string plainText, string encryptionPrivateKey = "")
        {
            ...
            if (String.IsNullOrEmpty(encryptionPrivateKey))
                encryptionPrivateKey = SecurityInfo.SECURE_PRIVATE_KEY;
